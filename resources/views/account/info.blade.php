    ...
    <main class="flex-1 p-10">
      ...
      <div class="bg-white p-8 rounded-2xl shadow-lg border border-pink-100 max-w-3xl">
        ...
        <div class="space-y-3 text-gray-700">
          <p><span class="font-semibold text-gray-800">Full Name:</span> {{ Auth::user()->name ?? 'Jane Doe' }}</p>
          <p><span class="font-semibold text-gray-800">Email:</span> {{ Auth::user()->email ?? 'janedoe@email.com' }}</p>
