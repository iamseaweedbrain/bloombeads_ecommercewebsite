...
<body class="min-h-screen bg-neutral"
      data-add-product-url="<?php echo e(route('admin.catalog.store')); ?>"
      data-base-update-url="<?php echo e(url('admin/catalog')); ?>"
      data-session-success="<?php echo e(session('success')); ?>"
      data-session-error="<?php echo e(session('error')); ?>">
    ...
    <div class="flex h-screen bg-neutral">
        ...
        <aside id="admin-sidebar" class="w-64 bg-white p-4 shadow-soft flex flex-col shrink-0 md:flex custom-scrollbar overflow-y-auto">
            ...
            <nav class="grow space-y-2">
                <a href="<?php echo e(route('admin.dashboard')); ?>" id="nav-dashboard" class="admin-nav-link w-full <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('admin.catalog.index')); ?>" id="nav-catalog" class="admin-nav-link w-full <?php echo e(request()->routeIs('admin.catalog.index') ? 'active' : ''); ?>">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
                    <span>Catalog Mgt</span>
                </a>
                <a href="<?php echo e(route('admin.transactions')); ?>" id="nav-transactions" class="admin-nav-link w-full <?php echo e(request()->routeIs('admin.transactions') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('admin.approvals')); ?>" id="nav-approvals" class="admin-nav-link w-full <?php echo e(request()->routeIs('admin.approvals') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('admin.notifications')); ?>" id="nav-notifications" class="admin-nav-link w-full <?php echo e(request()->routeIs('admin.notifications') ? 'active' : ''); ?>">
            ...
            <div class="shrink-0 mt-6 pt-4 border-t border-neutral">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p class="text-sm font-poppins font-semibold"><?php echo e(Session::get('admin_user')->username ?? 'Admin User'); ?></p>
...
<?php /**PATH C:\Users\Maxine\Herd\bloombeads_website\resources\views/layouts/admin.blade.php ENDPATH**/ ?>