    ...
    <section id="auth-view" class="py-12 md:py-24">
        <div class="max-w-md mx-auto bg-white card-radius shadow-soft p-8 text-center">
            ...
            <div id="forgot-password-container" class="space-y-4 hidden">
                <form id="forgot-password-form" method="POST" action="<?php echo e(route('requestOtp')); ?>" class="space-y-4">
                    <?php echo csrf_field(); ?>
            ...
            <div id="otp-verify-container" class="space-y-4 hidden">
                <form id="otp-verify-form" method="POST" action="<?php echo e(route('verifyOtp')); ?>" class="space-y-4">
                    <?php echo csrf_field(); ?>
            ...
            <div id="reset-password-container" class="space-y-4 hidden">
                <form id="reset-password-form" method="POST" action="<?php echo e(route('resetPassword')); ?>" class="space-y-4">
                    <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\Users\Maxine\Herd\bloombeads_website\resources\views/authentication.blade.php ENDPATH**/ ?>