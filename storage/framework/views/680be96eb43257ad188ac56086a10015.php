...
<?php $component->withAttributes([]); ?>
    ...
    <main class="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6 pb-16" 
          data-cart-add-url="<?php echo e($isLoggedIn ? route('cart.add') : ''); ?>">
        ...
        <script>
            ...
            window.addEventListener('load', () => {
                ...
                if (typeof initCatalog === 'function') {
                    initCatalog(PHP_PRODUCTS_DATA, <?php echo e($isLoggedIn ? 'true' : 'false'); ?>, '<?php echo e($authUrl); ?>');
                }
            });
        </script>
    </main>
...
<?php endif; ?><?php /**PATH C:\Users\Maxine\Herd\bloombeads_website\resources\views/browsecatalog.blade.php ENDPATH**/ ?>