...
<?php $component->withAttributes([]); ?>
    ...
    <section id="cart-view" 
             ...
             data-cart-remove-url="<?php echo e(route('cart.remove')); ?>"
             data-cart-update-url="<?php echo e(route('cart.update.quantity')); ?>">
        ...
        <div class="md:grid md:grid-cols-3 gap-8">
            <div class="md:col-span-2 space-y-4" id="cartContainer">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div
                        ...
                        data-cart-item-id="<?php echo e($item['cart_item_id']); ?>"
                        ...
                        <img src="<?php echo e($item['image_path'] ? asset('storage/' . $item['image_path']) : 'https://placehold.co/80x80/FF6B81/FFFFFF?text=B'); ?>" 
                             alt="<?php echo e($item['name'] ?? 'Product Image'); ?>" 
                             class="w-20 h-20 flex-shrink-0 card-radius object-cover bg-gray-100">

                        <div class="flex-grow">
                            <h4 class="font-poppins font-semibold text-dark"><?php echo e($item['name'] ?? 'Product Name'); ?></h4>
                            <p class="text-sm font-poppins text-dark/70">Category: <?php echo e($item['category'] ?? 'N/A'); ?></p>
                            <p class="font-poppins font-bold text-lg text-sakura mt-1">
                                ₱<?php echo e(number_format($item['price'] ?? 0, 2)); ?>
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex items-center border border-neutral rounded-lg overflow-hidden">
                                ...
                                <div
                                    ...
                                    data-quantity="<?php echo e($item['quantity'] ?? 1); ?>"
                                >
            ...
            <div
                ...
                <a href="<?php echo e(url('/browsecatalog')); ?>"
        ...
        <form id="checkoutForm" action="<?php echo e(route('cart.proceed')); ?>" method="POST" class="hidden">
            <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\Users\Maxine\Herd\bloombeads_website\resources\views/cart.blade.php ENDPATH**/ ?>